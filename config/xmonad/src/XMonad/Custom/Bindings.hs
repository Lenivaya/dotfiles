...
import XMonad.Actions.FlexibleManipulate qualified as F
...
import XMonad.Custom.Screenshot
...
keysDo :: XConfig Layout -> [(String, X ())]
keysDo _ =
  [ ("M-d s", wrapKbdLayout $ screenshotPrompt $ promptNoCompletion promptTheme)
  ]
