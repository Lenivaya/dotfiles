...
stdenv.mkDerivation {
  ...
  src = fetchurl {
    url = "https://releases.gitbutler.com/releases/release/0.14.0-1525/linux/x86_64/GitButler_0.14.0_amd64.deb";
    sha256 = "1zidqicymacraspg3c460w9mbvhr21ljys0mqb2wyndzf99d2g0h";
  };
